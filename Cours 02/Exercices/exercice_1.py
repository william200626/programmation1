...
NOM_CEGEP = CEGEP_DE_TROIS-RIVIÈRES
...
nom_famille = "Levasseur"       # str, au moins 2 caracteres
age = 20               # int, strictement positif
moyenne_generale = 72.5  # float, entre 0.0 et 100.0
...
nom_complet = f"{prenom}_{nom_famille}"
